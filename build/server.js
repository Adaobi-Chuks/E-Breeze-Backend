...
(() => __awaiter(void 0, void 0, void 0, function* () {
    errors_middlewares_1.logger.info(`Attempting to run server on port ${port}`);
    (0, database_configs_1.default)();
    app_1.default.listen(port, () => {
        errors_middlewares_1.logger.info(`Listening on port ${port}`);
    });
}))();
